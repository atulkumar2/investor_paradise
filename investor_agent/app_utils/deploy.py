...
@click.option(
    "--display-name",
    default="investor-paradise",
    help="Display name for the agent engine",
)
@click.option(
    "--description",
    default="AI-powered NSE stock analysis agent with interactive CLI and web interface",
    help="Description of the agent",
)
@click.option(
    "--source-packages",
    multiple=True,
    default=["./investor_agent"],
    help="Source packages to deploy. Can be specified multiple times (e.g., --source-packages=./app --source-packages=./lib)",
)
@click.option(
    "--entrypoint-module",
    default="investor_agent.agent_engine_app",
...
@click.option(
    "--requirements-file",
    default="investor_agent/app_utils/.requirements.txt",
    help="Path to requirements.txt file",
)
@click.option(
    "--env-file",
    default=None,
    help="Path to .env file for environment variables (defaults to investor_agent/.env)",
)
@click.option(
    "--set-env-vars",
    default=None,
