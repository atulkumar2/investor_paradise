...
━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
📅 Start Date: {STORE.min_date}
📅 End Date:   {STORE.max_date}
📊 Total Symbols: {STORE.total_symbols:,}
📈 Total Records: {len(STORE.df):,}

Use these dates as reference for all queries.
For 'latest week', use the 7 days ending on {STORE.max_date}."""
...
def get_top_gainers(start_date: str = None, end_date: str = None, top_n: int = 10) -> str:
    ...
    # Get ranked stocks
    ranked = STORE.get_ranked_stocks(s_date, e_date, top_n=top_n, metric="return")
...
def get_top_losers(start_date: str = None, end_date: str = None, top_n: int = 10) -> str:
    ...
    all_ranked = STORE.get_ranked_stocks(s_date, e_date, top_n=1000, metric="return")
...
def analyze_stock(symbol: str, start_date: str = None, end_date: str = None) -> str:
    ...
    # Get stock data
    stock_df = STORE.get_stock_data(symbol.upper(), s_date, e_date)
